...
import { Customer, Representative } from 'apps/app/src/app/demo/api/customer';
import { Product } from 'apps/app/src/app/demo/api/product';
import { CustomerService } from 'apps/app/src/app/demo/service/customer.service';
  ...
  ngOnInit() {
    this.customerService.getCustomersLarge().then((customers) => {
      ...
      this.customers1.forEach(
        (customer) => (customer.date = new Date(customer?.date as any) as any)
      );
    });
