    ...
    RouterModule.forChild([
      {
        ...
        loadChildren: () =>
          import('./button/buttondemo.module').then((m) => m.ButtonDemoModule)
      },
      {
        path: 'charts',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./file/filedemo.module').then((m) => m.FileDemoModule)
      },
      {
        path: 'floatlabel',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./input/inputdemo.module').then((m) => m.InputDemoModule)
      },
      {
        path: 'invalidstate',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./misc/miscdemo.module').then((m) => m.MiscDemoModule)
      },
      {
        path: 'overlay',
